...
public class QuizQuizContentFacade {
    ...
    public Quiz setNewQuizExcept(Long presentQuizContentId, String categoryCode) {
        QuizContent quizContentEntity = quizContentService.getQuizContentExcept(presentQuizContentId, categoryCode);
        return quizService.addNewQuiz(quizContentEntity);
    }

    public Quiz setNewQuiz(String categoryCode) {
        QuizContent quizContentEntity = quizContentService.getRandomQuizContent(categoryCode);
        return quizService.addNewQuiz(quizContentEntity);
    }
}
